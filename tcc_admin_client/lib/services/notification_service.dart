...
class NotificationService {
  ...
  static const String _defaultChannelId = 'tcc_admin_default_channel';
  static const String _agentChannelId = 'tcc_admin_agents';
  static const String _userChannelId = 'tcc_admin_users';
  static const String _systemChannelId = 'tcc_admin_system';
  ...
  Future<void> _createNotificationChannels() async {
    ...
    const agentChannel = AndroidNotificationChannel(
      _agentChannelId,
      'Agent Updates',
      description: 'Agent verification and status updates',
    ...
    await _localNotifications
        .resolvePlatformSpecificImplementation<
            AndroidFlutterLocalNotificationsPlugin>()
        ?.createNotificationChannel(agentChannel);
  ...
  void _handleForegroundMessage(RemoteMessage message) {
    ...
    if (notification != null) {
      _showLocalNotification(
        title: notification.title ?? 'TCC Admin',
  ...
  void _handleNotificationNavigation(Map<String, dynamic> data) {
    ...
    // Example:
    // - agent -> Agent management screen
    // - user -> User details screen
    // - transaction -> Transaction review screen
  ...
  String _getChannelDescription(String channelId) {
    switch (channelId) {
      case _agentChannelId:
        return 'Agent verification and status updates';
      case _userChannelId:
        return 'User-related notifications';
      case _systemChannelId:
