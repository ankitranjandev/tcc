...
class NotificationService {
  ...
  static const String _defaultChannelId = 'tcc_user_default_channel';
  static const String _investmentChannelId = 'tcc_user_investments';
  static const String _transactionChannelId = 'tcc_user_transactions';
  static const String _promotionChannelId = 'tcc_user_promotions';
  static const String _systemChannelId = 'tcc_user_system';
  ...
  Future<void> _createNotificationChannels() async {
    ...
    const investmentChannel = AndroidNotificationChannel(
      ...
      'Investment Updates',
      description: 'Investment maturity and return notifications',
  ...
  void _handleNotificationNavigation(Map<String, dynamic> data) {
    ...
    // Example:
    // - investment -> Investment details screen
    // - transaction -> Transaction history screen
    // - promotion -> Promotion details screen
  ...
  String _getChannelDescription(String channelId) {
    switch (channelId) {
      case _investmentChannelId:
        return 'Investment maturity and return notifications';
      case _transactionChannelId:
